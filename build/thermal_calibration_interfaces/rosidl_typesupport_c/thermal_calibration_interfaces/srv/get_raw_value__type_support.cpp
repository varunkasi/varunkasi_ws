...
static const _GetRawValue_Request_type_support_symbol_names_t _GetRawValue_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, thermal_calibration_interfaces, srv, GetRawValue_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, thermal_calibration_interfaces, srv, GetRawValue_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, thermal_calibration_interfaces, srv, GetRawValue_Request)() {
  return &::thermal_calibration_interfaces::srv::rosidl_typesupport_c::GetRawValue_Request_message_type_support_handle;
}
...
static const _GetRawValue_Response_type_support_symbol_names_t _GetRawValue_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, thermal_calibration_interfaces, srv, GetRawValue_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, thermal_calibration_interfaces, srv, GetRawValue_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, thermal_calibration_interfaces, srv, GetRawValue_Response)() {
  return &::thermal_calibration_interfaces::srv::rosidl_typesupport_c::GetRawValue_Response_message_type_support_handle;
}
...
static const _GetRawValue_type_support_symbol_names_t _GetRawValue_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, thermal_calibration_interfaces, srv, GetRawValue)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, thermal_calibration_interfaces, srv, GetRawValue)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, thermal_calibration_interfaces, srv, GetRawValue)() {
  return &::thermal_calibration_interfaces::srv::rosidl_typesupport_c::GetRawValue_service_type_support_handle;
}
