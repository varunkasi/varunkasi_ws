...
static const _AddCalibrationPoint_Request_type_support_symbol_names_t _AddCalibrationPoint_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, thermal_calibration_interfaces, srv, AddCalibrationPoint_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, thermal_calibration_interfaces, srv, AddCalibrationPoint_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, thermal_calibration_interfaces, srv, AddCalibrationPoint_Request)() {
  return &::thermal_calibration_interfaces::srv::rosidl_typesupport_c::AddCalibrationPoint_Request_message_type_support_handle;
}
...
static const _AddCalibrationPoint_Response_type_support_symbol_names_t _AddCalibrationPoint_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, thermal_calibration_interfaces, srv, AddCalibrationPoint_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, thermal_calibration_interfaces, srv, AddCalibrationPoint_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, thermal_calibration_interfaces, srv, AddCalibrationPoint_Response)() {
  return &::thermal_calibration_interfaces::srv::rosidl_typesupport_c::AddCalibrationPoint_Response_message_type_support_handle;
}
...
static const _AddCalibrationPoint_type_support_symbol_names_t _AddCalibrationPoint_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, thermal_calibration_interfaces, srv, AddCalibrationPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, thermal_calibration_interfaces, srv, AddCalibrationPoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, thermal_calibration_interfaces, srv, AddCalibrationPoint)() {
  return &::thermal_calibration_interfaces::srv::rosidl_typesupport_c::AddCalibrationPoint_service_type_support_handle;
}
