...
static const _CalibrationPoint_type_support_symbol_names_t _CalibrationPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, thermal_calibration_interfaces, msg, CalibrationPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, thermal_calibration_interfaces, msg, CalibrationPoint)),
  }
};
...
{
  return &::thermal_calibration_interfaces::msg::rosidl_typesupport_cpp::CalibrationPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, thermal_calibration_interfaces, msg, CalibrationPoint)() {
  return get_message_type_support_handle<thermal_calibration_interfaces::msg::CalibrationPoint>();
}
