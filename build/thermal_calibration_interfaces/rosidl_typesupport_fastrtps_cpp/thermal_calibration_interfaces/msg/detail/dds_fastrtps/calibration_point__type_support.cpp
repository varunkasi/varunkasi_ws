...
#include "thermal_calibration_interfaces/msg/detail/calibration_point__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = thermal_calibration_interfaces::msg::CalibrationPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const thermal_calibration_interfaces::msg::CalibrationPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<thermal_calibration_interfaces::msg::CalibrationPoint *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CalibrationPoint__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const thermal_calibration_interfaces::msg::CalibrationPoint *>(
...
static size_t _CalibrationPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CalibrationPoint(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CalibrationPoint__callbacks = {
...
static rosidl_message_type_support_t _CalibrationPoint__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CalibrationPoint__callbacks,
...
get_message_type_support_handle<thermal_calibration_interfaces::msg::CalibrationPoint>()
{
  return &thermal_calibration_interfaces::msg::typesupport_fastrtps_cpp::_CalibrationPoint__handle;
}
