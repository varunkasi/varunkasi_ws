...
#include "thermal_calibration_interfaces/msg/detail/calibration_model__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const thermal_calibration_interfaces::msg::CalibrationModel & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.raw_value_range;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  thermal_calibration_interfaces::msg::CalibrationModel & ros_message)
{
  // Member: model_type
  cdr >> ros_message.model_type;
  ...
  size_t current_alignment)
{
  ...
  // Member: raw_value_range
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.raw_value_range[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_thermal_calibration_interfaces
max_serialized_size_CalibrationModel(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = thermal_calibration_interfaces::msg::CalibrationModel;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const thermal_calibration_interfaces::msg::CalibrationModel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<thermal_calibration_interfaces::msg::CalibrationModel *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CalibrationModel__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const thermal_calibration_interfaces::msg::CalibrationModel *>(
...
static size_t _CalibrationModel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CalibrationModel(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CalibrationModel__callbacks = {
...
static rosidl_message_type_support_t _CalibrationModel__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CalibrationModel__callbacks,
...
{
  return &thermal_calibration_interfaces::msg::typesupport_fastrtps_cpp::_CalibrationModel__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, thermal_calibration_interfaces, msg, CalibrationModel)() {
  return &thermal_calibration_interfaces::msg::typesupport_fastrtps_cpp::_CalibrationModel__handle;
}
